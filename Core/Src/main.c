...
int main(void)
{
	...
	while (1)
	{
		...
		/* From this point, everything in the system should be handled using the Interface functions.
		 *
		 * Edit the system_setup.h file to add/remove features.
		 *
		 * Follow the guide below to add different libraries to the system:
		 *
