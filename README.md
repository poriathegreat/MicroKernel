...
taking no space."
    ...
    system_setup --> sys_addon : Auto Generated
    ...
    class sys_addon{
        ...
        Result: sys.c(autogenerated)
        Result: sys.h(autogenerated)
    }

    sys_addon -- sys_statusled : Must be Edited
    class sys_statusled{
    ...
    sys_addon -- sys_battery : Must be Edited
    class sys_battery{
    ...
    sys_addon -- sys_standby : Must be Edited
    class sys_standby{
        enum syswakeup_t[
        	SLEEP = 1,
        	AWAKE = 0
